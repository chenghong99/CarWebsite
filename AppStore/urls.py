...
urlpatterns = [
    ...
    path('search_results/<str:pick_up>/<str:drop_off>/<str:max_year>/<str:max_mileage>/<str:min_rate>/<str:max_rate>/<str:carmakes_id>', app.views.search_results, name='search_results'),
